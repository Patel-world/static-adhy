...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        this.clearClass = 'button button-blue';
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu '+ options.classContainer +'">' +
        ...
        if (hasOptions) {
            ...
            if (typeof options.onlyPicker == 'boolean') {
                this.onlyPicker = options.onlyPicker;
            }
    ...
    DateRangePicker.prototype = {
        ...
        notify: function () {
            ...
            if (this.element.is('input')) {
                ...
                if(this.onlyPicker){
                    this.element.val(this.cleared ? '' : this.endDate.format(this.format));
        ...
        updateTime: function(e) {
            ...
            if (isLeft) {
                ...
                start.hour(hour);
                start.minute(minute);
                if (!start.isSame(this.startDate))
                    this.changed = true;
                this.startDate = start;
